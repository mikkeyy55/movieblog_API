...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Hello,</p>
            <p>
                You have requested to {{ $type === 'admin' ? 'access the admin panel' : 'log in to your account' }}
                for Movie Database. Please use the verification code below to complete your
